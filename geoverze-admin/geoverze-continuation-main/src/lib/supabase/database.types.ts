 ...
 *
 * This is the SAME Supabase project as geoverze-main; the type file is
 * duplicated (not shared via a package) because the two apps are separate,
 * independently-built projects with no shared workspace today.
 */
