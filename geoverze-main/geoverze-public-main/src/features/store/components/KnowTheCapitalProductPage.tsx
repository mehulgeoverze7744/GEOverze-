...
import tshirtBurgundy from "@/assets/geostore/tshirt-know-the-capital-burgundy.png";
import tshirtOliveGreen from "@/assets/geostore/tshirt-know-the-capital-olive-green.png";
import tshirtOffWhite from "@/assets/geostore/tshirt-know-the-capital-off-white.png";
...
export const KnowTheCapitalProductPage = memo(function KnowTheCapitalProductPage({
  product,
}: {
    ...
    <PageShell>
      ...
      <div className="relative z-10">
            ...
            <div className="min-w-0 space-y-4">
              ...
              <div>
                <AccordionRow title="Description" icon={FileText}>
                  <p>
                    {product.tagline} Front and back print: I KNOW THE CAPITAL. YOU KNOW THE VIBES.
                  </p>
                </AccordionRow>
                ...
                <AccordionRow title="Care" icon={Shirt}>
                  <p>
                    ...
                    screen-printed cotton: wash inside-out, cool, and avoid high heat until we
                    publish the full care card.
                  </p>
                </AccordionRow>
                <AccordionRow title="Shipping" icon={Truck}>
                  <p>
                    Physical fulfilment is not live yet. Shipping options and delivery windows will
                    be listed here when this tee becomes available to order.
                  </p>
                </AccordionRow>
              </div>
            </div>
            ...
            <div className="min-w-0 space-y-5 md:sticky md:top-[calc(var(--nav-height)+1.25rem)]">
              ...
              <div>
                ...
                <p className="mt-2 max-w-md text-sm leading-relaxed text-foreground/50">
                  A city-inspired GEOverze tee with the globe emblem on the front and a bold
                  capital-city graphic on the back.
                </p>
              </div>
        ...
        <Modal
          ...
          description="Front and back views — I Know the Capital. You Know the Vibes."
        >
          <img
            src={selectedVariant.image}
