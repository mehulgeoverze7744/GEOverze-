...
export const PRODUCTS: readonly Product[] = [
  ...
  make({
    slug: "field-notebook",
    name: "Field Notebook",
    tagline: "Dot-grid, lay-flat, bronze foil emblem.",
  ...
  make({
    slug: "explorer-tote",
    name: "Explorer Tote",
    tagline: "Heavy canvas with a printed hemisphere.",
    category: "accessories",
    price: 2_600,
    credits: 260,
    rating: 4.5,
  ...
  make({
    slug: "emblem-pin",
    name: "Emblem Enamel Pin",
    tagline: "Solid brass, hand-polished.",
    category: "accessories",
    price: 1_400,
    credits: 140,
    rating: 4.8,
  ...
  make({
    ...
    tagline: "12 cm sphere on a bronze meridian.",
    category: "accessories",
    price: 9_800,
    credits: null,
    rating: 4.9,
