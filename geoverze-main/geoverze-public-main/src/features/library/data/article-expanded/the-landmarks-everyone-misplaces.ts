...
export const BLOCKS: readonly ArticleBlock[] = [
  ...
  { kind: "heading", id: "panama-canal", text: "The Panama Canal: the Pacific end is east of the Atlantic end" },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    externalSrc: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/PanamaCanal-EO.JPG/1280px-PanamaCanal-EO.JPG",
    caption: "NASA satellite view of the Panama Canal — the Pacific entrance (lower right) is east of the Atlantic entrance (upper left), confounding most people's mental maps.",
  ...
  { kind: "heading", id: "sydney-latitude", text: "Sydney's latitude: same as Cape Town, not Melbourne" },
  {
    kind: "paragraph",
  ...
  { kind: "heading", id: "cairo-position", text: "Cairo is at the northern tip of Egypt, not the centre" },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    externalSrc: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Nile_River_Delta_at_Night_-_Flickr_-_NASA_Goddard_Photo_and_Video.jpg/1280px-Nile_River_Delta_at_Night_-_Flickr_-_NASA_Goddard_Photo_and_Video.jpg",
    caption: "NASA night image of the Nile Delta — Cairo and Alexandria glow at the very northern tip of Egypt; almost no light appears to the south, where most of Egypt's land area lies.",
  ...
  { kind: "heading", id: "india-scale", text: "India's true scale: larger than all of Western Europe" },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    externalSrc: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/California_terrain.jpg/640px-California_terrain.jpg",
    caption: "California terrain map showing the dramatic southeastward curve of the coast — Los Angeles sits further east than Reno, Nevada, despite being on the Pacific coast.",
    credit: "Wikimedia Commons / Public Domain",
  },

  { kind: "heading", id: "uk-russia-latitude", text: "The UK and Russia share more latitude than you think" },
  {
    kind: "paragraph",
  ...
  { kind: "heading", id: "antarctica-largest-desert", text: "Antarctica is the world's largest desert" },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    facts: [
      { label: "Antarctic Desert (cold)", value: "~14.2 million km² — world's largest; < 200 mm precipitation/year" },
      { label: "Arctic Desert (cold)", value: "~13.9 million km² — second largest; < 250 mm precipitation/year" },
      ...
      { label: "Patagonian Desert (cold)", value: "~670,000 km² — South America, rain shadow of Andes" },
    ],
  },
  {
    kind: "callout",
  ...
  { kind: "heading", id: "everest-chimborazo", text: "Everest vs Chimborazo: two different meanings of 'highest'" },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    externalSrc: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Chimborazo_volcano.jpg/1280px-Chimborazo_volcano.jpg",
    caption: "Chimborazo, Ecuador (6,263 m) — lower than Everest above sea level, but further from Earth's centre due to the equatorial bulge of the planet.",
  ...
  { kind: "heading", id: "africa-south-america", text: "Africa and South America: closer than they look" },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    externalSrc: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Snider-Pellegrini_Wegener_fossil_map.svg/1280px-Snider-Pellegrini_Wegener_fossil_map.svg",
    caption: "Wegener's 1915 diagram showing matching fossil and geological evidence across Africa and South America — the narrowest Atlantic crossing is about 2,850 km.",
    credit: "Wikimedia Commons / Public Domain",
  },
  {
    kind: "callout",
  ...
  },
  {
    ...
    externalSrc: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Mercator_projection_Square.JPG/1280px-Mercator_projection_Square.JPG",
    caption: "The Mercator projection — designed for navigation, not for area comparison. Greenland appears roughly the size of Africa; in reality Africa is 14 times larger.",
    credit: "Wikimedia Commons / Public Domain",
  },
  {
    kind: "callout",
  ...
  { kind: "heading", id: "international-date-line", text: "The International Date Line: it doesn't run straight" },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    externalSrc: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/International_date_line.png/1280px-International_date_line.png",
    caption: "The International Date Line — far from straight, it zigzags around Kiribati, Samoa, Tonga, and Fiji to keep island nations on one calendar day.",
    credit: "Wikimedia Commons / Public Domain",
  },
  {
    kind: "callout",
  ...
  { kind: "heading", id: "europe-northern-latitude", text: "Europe's surprisingly northern position" },
  {
    kind: "paragraph",
  ...
  { kind: "heading", id: "brazil-hemispheres", text: "Brazil is mostly in the southern hemisphere" },
  {
    kind: "paragraph",
  ...
  { kind: "heading", id: "misconceptions-table", text: "Ten geographic misconceptions and their corrections" },
  {
    kind: "table",
    title: "Commonly held geographic beliefs and the reality",
    columns: ["The common belief", "The reality", "Why it matters"],
    rows: [
      ["The Panama Canal runs west-east", "It runs roughly NW-SE; the Pacific end is east of the Atlantic end", "Navigation and strategic geography"],
      ["Sydney is in southern Australia", "Sydney (33.9°S) is near Cape Town's latitude — it's subtropical", "Climate expectations, tourist planning"],
      ["Cairo is roughly in Egypt's centre", "Cairo is at the very northern tip of Egypt, at the Nile Delta apex", "Understanding Egypt's geography and demographics"],
      ["India is a medium-sized country", "India (3.29M km²) is larger than all of Western Europe combined", "Scale of governance, diversity, logistics"],
      ["Nevada is east of California (entirely)", "Reno (119.8°W) is west of Los Angeles (118.2°W)", "US West Coast geography"],
      ["The Sahara is the world's largest desert", "Antarctica (14.2M km²) is the largest; the Sahara is third overall", "Definition of desert as precipitation-based"],
      ["Everest is the mountain farthest from Earth's centre", "Chimborazo in Ecuador is furthest from Earth's centre due to equatorial bulge", "Earth's shape, satellite orbital geometry"],
      ["New Zealand is close to Australia", "Auckland–Sydney = 2,157 km, same as London–Cairo", "Pacific geography, distance misperception"],
      ["Greenland is as large as Africa", "Africa (30.4M km²) is 14× larger than Greenland (2.17M km²)", "Mercator projection distortion"],
      ["The International Date Line runs straight", "It zigzags around Kiribati, Samoa, Tonga, and Fiji", "Pacific political geography"],
    ],
  },

  { kind: "heading", id: "geographic-surprises", text: "Geographic facts that surprise most people" },
  {
    kind: "facts",
    title: "Surprising geographic facts",
    facts: [
      { label: "Africa's actual size vs. common perception", value: "Africa (30.4M km²) fits USA, China, India, and Europe simultaneously" },
      { label: "Russia's population despite size", value: "Russia (17.1M km²) has only 144M people — smaller than Nigeria's 220M" },
      { label: "Australia's population vs. size", value: "Australia (7.7M km²) has only 26M people — one of the lowest density inhabited continents" },
      { label: "Panama Canal's transit direction", value: "Ships travel SE to reach Pacific from Atlantic — not west" },
      { label: "Hawaii's position", value: "Hawaii (19-22°N) is the southernmost US state, level with Mexico City" },
      { label: "Distance from tip of Chile to Antarctic Peninsula", value: "Drake Passage is 800 km — shortest route from any continent to Antarctica" },
    ],
  },

  { kind: "heading", id: "why-mental-maps-fail", text: "Why our mental maps are wrong in the same places" },
  {
    kind: "paragraph",
