...
export const BLOCKS: readonly ArticleBlock[] = [
  ...
  },
  {
    ...
    externalSrc:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Khartoum_-_Blue_and_White_Nile_confluence.jpg/1280px-Khartoum_-_Blue_and_White_Nile_confluence.jpg",
    caption:
      "The confluence of the Blue and White Nile at Khartoum, Sudan — where two river systems with different sources meet, their waters remaining visibly distinct for kilometres before mixing.",
  ...
  },
  {
    ...
    facts: [
      ...
      {
        label: "Most remote source (White Nile)",
        value: "Ruvyironza River, Burundi (~2,000 m elevation)",
      },
      ...
      {
        label: "Annual discharge at mouth",
        value: "~2,830 m³/s (highly variable; near-zero some years)",
      },
      { label: "Basin area", value: "3.4 million km²" },
      {
        label: "Countries in basin",
        value:
          "11 (Burundi, DRC, Egypt, Eritrea, Ethiopia, Kenya, Rwanda, South Sudan, Sudan, Tanzania, Uganda)",
      },
    ],
  },
  ...
  {
    kind: "heading",
    id: "source-of-nile-debate",
    text: "The source of the Nile: a 2,000-year debate",
  },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    externalSrc:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Nile_delta_from_orbit.jpg/800px-Nile_delta_from_orbit.jpg",
    caption:
      "The Nile Delta from orbit — the triangular green wedge against the Saharan beige is one of Earth's most recognisable features from space, representing one of the oldest continuously farmed landscapes on Earth.",
  ...
  },
  {
    ...
    externalSrc:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Amazon_River_plume.jpg/1280px-Amazon_River_plume.jpg",
    caption:
      "The Amazon's freshwater plume extending into the Atlantic Ocean. The sediment-rich discharge is visible from space as a turbid wedge stretching hundreds of kilometres from the Brazilian coast.",
  ...
  },
  {
    ...
    facts: [
      {
        label: "Conventional length",
        value: "6,400 km (contested; up to 6,992 km with Mantaro source)",
      },
      {
        label: "Source (2007 survey)",
        value: "Mantaro River headwaters, Peru, ~5,170 m elevation",
      },
      ...
      { label: "Basin area", value: "7.0 million km² — 40% of South America" },
      {
        label: "Countries in basin",
        value:
          "9 (Bolivia, Brazil, Colombia, Ecuador, Guyana, Peru, Suriname, Venezuela, French Guiana)",
      },
      { label: "Share of global freshwater river discharge", value: "~20%" },
      {
        label: "Estimated fish species",
        value: "~3,000 (more than all Atlantic Ocean fish species)",
      },
    ],
  },
  ...
  {
    kind: "heading",
    id: "amazon-basin-scale",
    text: "The Amazon basin: scale that defies description",
  },
  {
    kind: "paragraph",
  ...
  {
    kind: "heading",
    id: "nile-civilizations",
    text: "The Nile and civilisation: 5,000 years of hydraulic history",
  },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    art: "aswan-high-dam",
    externalSrc:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Aswan_High_Dam.JPG/1280px-Aswan_High_Dam.JPG",
    caption:
      "The Aswan High Dam, completed in 1970 — it ended the annual Nile flood cycle, eliminated silt delivery to the delta, and created Lake Nasser (550 km long), while requiring the relocation of Abu Simbel.",
...

  {
    kind: "heading",
    id: "aswan-dam",
    text: "The Aswan High Dam: solving one problem, creating another",
  },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    art: "gerd-dam",
    externalSrc:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Grand_Ethiopian_Renaissance_Dam.jpg/1280px-Grand_Ethiopian_Renaissance_Dam.jpg",
    caption:
      "The Grand Ethiopian Renaissance Dam (GERD) on the Blue Nile — Africa's largest hydroelectric project, at the centre of an ongoing diplomatic dispute between Ethiopia, Egypt, and Sudan.",
...

  {
    kind: "heading",
    id: "amazon-ecosystem",
    text: "The Amazon ecosystem: 10% of all life on Earth",
  },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    externalSrc:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Boto_-_Inia_geoffrensis_%28Wikimedia_Commons%29.jpg/1280px-Boto_-_Inia_geoffrensis_%28Wikimedia_Commons%29.jpg",
    caption:
      "The boto (pink river dolphin) — one of the Amazon's most distinctive species, navigating the flooded forest using echolocation to hunt fish among submerged trees.",
    credit: "Wikimedia Commons / CC BY-SA 3.0",
  },
  {
    kind: "callout",
...

  {
    kind: "heading",
    id: "flying-rivers",
    text: "Flying rivers: how the Amazon makes its own rain",
  },
  {
    kind: "paragraph",
...

  {
    ...
    text: "Amazon deforestation: racing toward the tipping point",
  },
  {
    kind: "paragraph",
  ...
  },
  {
    ...
    externalSrc:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/Deforestation_in_the_Amazon_-_Brazil.jpg/1280px-Deforestation_in_the_Amazon_-_Brazil.jpg",
    caption:
      "Deforestation at the Amazon frontier — the sharp boundary between intact rainforest and cleared cattle pasture is characteristic of the arc of deforestation in the Brazilian states of Pará and Mato Grosso.",
    credit: "Wikimedia Commons / CC BY 2.0",
  },

  {
    kind: "heading",
    id: "people-of-the-nile",
    text: "The people of the Nile: 250 million in the basin",
  },
  {
    kind: "paragraph",
  ...
  {
    kind: "heading",
    id: "people-of-the-amazon",
    text: "The people of the Amazon: 400 indigenous nations",
  },
  {
    kind: "paragraph",
  ...
  { kind: "heading", id: "nile-timeline", text: "Timeline: the Nile through history" },
  {
    ...
    events: [
      {
        date: "~3100 BC",
        text: "Unification of Upper and Lower Egypt under pharaonic rule, made possible by the Nile's predictable flood cycle and the delta's agricultural productivity.",
      },
      {
        date: "~2560 BC",
        text: "Great Pyramid of Giza constructed using Nile transport for limestone blocks from Tura quarries.",
      },
      {
        date: "~450 BC",
        text: "Herodotus travels the Nile, describes Egypt as 'the gift of the Nile' — a phrase that captures the civilisational dependence on annual flooding.",
      },
      {
        date: "AD 1858",
        text: "Burton and Speke expedition reaches Lake Victoria; Speke correctly identifies it as the White Nile's primary reservoir, but Burton disputes the finding.",
      },
      {
        date: "1875",
        text: "Henry Morton Stanley confirms Lake Victoria as the Nile's reservoir and identifies Ripon Falls (now submerged by Owen Falls Dam) as the outlet.",
      },
      {
        date: "1970",
        text: "Aswan High Dam completed; ends annual Nile flood, eliminates silt delivery to delta, creates 550 km Lake Nasser, requires displacement of 100,000 Nubians.",
      },
      {
        date: "2011",
        text: "Construction begins on the Grand Ethiopian Renaissance Dam (GERD) on the Blue Nile in Ethiopia.",
      },
      {
        date: "2022–24",
        text: "GERD begins power generation and reaches full operation; Egypt–Ethiopia–Sudan diplomatic negotiations remain unresolved.",
      },
    ],
  },
  ...
  { kind: "heading", id: "amazon-timeline", text: "Timeline: the Amazon through European eyes" },
  {
    ...
    events: [
      {
        date: "1541–42",
        text: "Francisco de Orellana leads the first European navigation of the full Amazon, from the Napo River tributary to the Atlantic — a journey of over 6,000 km.",
      },
      {
        date: "1639",
        text: "Pedro Teixeira leads the first upstream navigation of the Amazon from Belém to Quito, establishing Portuguese claims to the basin.",
      },
      {
        date: "1799–1804",
        text: "Alexander von Humboldt explores the Orinoco-Amazon connection (the Casiquiare canal), establishing the scientific study of Amazonian hydrology.",
      },
      {
        date: "1848–52",
        text: "Alfred Russel Wallace and Henry Walter Bates conduct biological surveys of the Amazon, documenting thousands of new species.",
      },
      {
        date: "1960s",
        text: "Brazil begins constructing Trans-Amazonian Highway; large-scale deforestation begins along access roads.",
      },
      {
        date: "1988",
        text: "Brazilian environmental activist Chico Mendes assassinated; his death galvanises global Amazon conservation movement.",
      },
      {
        date: "2004",
        text: "PRODES deforestation monitoring system detects peak deforestation year: 27,000 km² lost in a single year.",
      },
      {
        date: "2007",
        text: "Brazilian-Peruvian survey traces Amazon to Mantaro River source, measuring length at ~6,992 km — potentially longer than the Nile.",
      },
      {
        date: "2019",
        text: "Unprecedented dry season fires burn ~9.7 million hectares of the Amazon under loosened enforcement policies.",
      },
      {
        date: "2023",
        text: "Amazon deforestation in Brazil falls to lowest level in 15 years following change in government and enforcement policy.",
      },
    ],
  },
  ...
  {
    kind: "heading",
    id: "climate-change-connections",
    text: "Climate change: both rivers under threat",
  },
  {
    kind: "paragraph",
