...
import { DoorOpen, Lock, Plus, Users } from "lucide-react";
...
/** /play/multiplayer — private-room entry: create or join by code. */
export function MultiplayerHubScreen() {
        ...
        <SectionContainer className="pt-[calc(var(--nav-height)+var(--space-section-sm))] pb-[var(--space-section-sm)]">
          <AnimatedSection className="mx-auto max-w-xl text-center">
            ...
            <p className="mt-4 text-[0.9rem] leading-relaxed text-foreground/60">
              Private multiplayer rooms require an account so your room code, roster and progression
              stay tied to you.
            </p>
    ...
    <PageShell>
      <SectionContainer className="pt-[calc(var(--nav-height)+var(--space-section-sm))] pb-[var(--space-section-sm)]">
        <AnimatedSection className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-[0.9rem] leading-relaxed text-foreground/60">
            Create a private room, share the six-character code, and start once at least three
            players are ready.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection className="mx-auto mt-10 grid max-w-2xl gap-4 sm:grid-cols-2">
          <GeoButton variant="solid" size="lg" className="h-auto flex-col gap-3 py-8" asChild>
            <Link to="/play/multiplayer/create">
